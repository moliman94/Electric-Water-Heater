...
# 2 "<built-in>" 2
# 1 "SYSTEM_STATE_UPDATE_TASK.c" 2
...
# 1 "./SYSTEM_STATE_UPDATE_TASK.h" 1
# 11 "./SYSTEM_STATE_UPDATE_TASK.h"
# 1 "./main.h" 1
# 11 "./main.h"
...
# 11 "./SYSTEM_STATE_UPDATE_TASK.h" 2
...
uint32 DelayCount;
# 18 "./Port.h" 2
# 12 "./SYSTEM_STATE_UPDATE_TASK.h" 2

# 1 "./STATES.h" 1
# 13 "./SYSTEM_STATE_UPDATE_TASK.h" 2
...
# 14 "./SYSTEM_STATE_UPDATE_TASK.h" 2
...
# 15 "./SYSTEM_STATE_UPDATE_TASK.h" 2
...
void SYSTEM_STATE_UPDATE_TASK(void)
{
    ...
    {
    case 1:
        if ((UP_SW_pressed_st == (!0)) || (DOWN_SW_pressed_st == (!0)))
        {
            System_state = 2;

            UP_SW_pressed_st = 0;
            DOWN_SW_pressed_st = 0;
        }
        break;
    ...
    case 2:
        ...
        {
            if (UP_SW_pressed_st == (!0))
            {
                Read_Button_state = 2;
                Timeout_button = 0;
            }

            if (DOWN_SW_pressed_st == (!0))
            {
                Read_Button_state = 4;
                Timeout_button = 0;
            }
