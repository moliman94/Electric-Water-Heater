...
void SCH_init_TMR1(void)
{
    ...
    TMR1 = (65536-((8000000UL)/(4*1))*((5)/1000.0));
...
void SCH_Update_Task(void)
{
    ...
    TMR1 = (65536-((8000000UL)/(4*1))*((5)/1000.0)) - (65536-((8000000UL)/(4*1))*(0.25f/1000.0));
...
uint8 SCH_Add_Task(void (*ptr_fun)(), const uint16 Delay, const uint16 Period)
{
    ...
    while ((SCH_tasks[Index].ptr_Task != 0) && (Index < (3)))
        Index++;
