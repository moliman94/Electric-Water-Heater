...
# 1 "./Read_Buttons_Task.h" 1
# 11 "./Read_Buttons_Task.h"
# 1 "./main.h" 1
# 11 "./main.h"
...
uint32 DelayCount;
# 18 "./Port.h" 2
# 12 "./Read_Buttons_Task.h" 2

# 1 "./STATES.h" 1
# 13 "./Read_Buttons_Task.h" 2
...
uint8 get_key(void);
void debounce(uint8 *key);
void UP_SW_change_state(void);
# 14 "./Read_Buttons_Task.h" 2
# 8 "Read_Buttons_Task.c" 2


s_int8 Set_temp = 60;
extern uint8 UP_SW_pressed_st;
# 20 "Read_Buttons_Task.c"
