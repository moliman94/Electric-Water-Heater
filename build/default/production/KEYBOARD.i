...
uint8 ON_OFF_SW_pressed_st = 0;
uint8 UP_SW_pressed_st = 0;
uint8 DOWN_SW_pressed_st = 0;
# 28 "KEYBOARD.c"
...
void UP_switch_update(void)
{
    ...
    if (((PORTB>>2)&1) == (0))
    {
        ...
        if (UP_Sw_press_duration_G > (2))
        {
            UP_Sw_press_duration_G = (2);
...
void DOWN_switch_update(void)
{
    ...
    if (((PORTB>>1)&1) == (0))
    {
        ...
        if (DOWN_Sw_press_duration_G > (2))
        {
            DOWN_Sw_press_duration_G = (2);
